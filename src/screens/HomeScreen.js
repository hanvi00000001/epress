    ...
    <View style={styles.fliterView}>
      <View style={styles.addressView}>
        <View style={{flexDirection:"row",alignItems:"center",paddingLeft:10}}>
          <Icon
            ...
            size={26}
          />
          <Text style={{marginLeft:10}}>20 Tăng Nhơn Phú</Text>
        </View>
        </View>
      ...
      <View>
        <View style={{flexDirection:"row",alignItems:"center"}}>
          <Text style={{marginLeft:15,fontSize:16,marginTop:-10,marginRight:5}}>Option chnaging in</Text>
          <CountDown
            until={3600}
            size ={14}
